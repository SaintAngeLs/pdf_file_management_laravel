            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Status update">
                        <button type="button" id="visible-btn-<?php echo e($document->id); ?>" class="btn  <?php echo e($document->status ? 'btn-success btn-sm' : 'btn-outline-success btn-sm '); ?> btn-sm" onclick="updateStatus('<?php echo e($document->id); ?>', 'visible')">Visible</button>
                        <button type="button" id="invisible-btn-<?php echo e($document->id); ?>" class="btn btn-sm <?php echo e(!$document->status ? 'btn-danger btn-sm' : 'btn-outline-danger btn-sm'); ?> btn-sm" onclick="updateStatus('<?php echo e($document->id); ?>', 'invisible')">Invisible</button>
                    </div>
                </td>
...
<?php /**PATH /home/kaliuser/Documents/portfolio/a_work/brige_AAAoriginal/bridge_newsletter/resources/views/admin/userdocument.blade.php ENDPATH**/ ?>