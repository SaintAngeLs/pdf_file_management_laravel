...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate action="{{route('document.edit.save')}}" method="POST" enctype="multipart/form-data" id="documentForm">
            @csrf
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="form-control" id="uploadDate" name="upload_date" value="{{$data->upload_date}}" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-12">
                ...
                <select class="form-select" id="status" name="status" required>
                    <option value="1" {{ $data->status ? 'selected' : '' }}>Visible</option>
                    <option value="0" {{ !$data->status ? 'selected' : '' }}>Invisible</option>
                </select>
                <div class="invalid-feedback">
